...
public class CyrillicLatinConverter {
    ...
    public static String latinToCyrillic(String latinText) {
        StringBuilder latBuffer = new StringBuilder(latinText);
        StringBuilder cyrBuffer = new StringBuilder();
    ...
    public static String cyrillicToLatin(String cyrillicText) {
        StringBuilder cyrBuffer = new StringBuilder(cyrillicText);
